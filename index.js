...
function whoWon() {
  ...
  function letsPlay() {
    var numPlaysInput = document.getElementById("numPlays");
    var numPlays = parseInt(numPlaysInput.value);
  
    if (isNaN(numPlays) || numPlays <= 0) {
      alert("Please enter a valid number of plays greater than zero.");
      return;
    }
